                    ...
                    <div className="heading w-full h-full mx-auto flex items-center flex-col gap-4 py-10 px-12">
                        <div className="grid grid-cols-6 gap-10 w-full ">
                            {Testiomonialsdata.map((item) => (
                                <div
                                    key={item.id}
                                    className="col-span-3 rounded-3xl bg-[#232323] p-10 flex items-start flex-col gap-11 border-[1px] gradient 
                                    ...
                                    <p className="text-gray-300 text-start text-[1.2vw] transition-colors duration-300 ease-in-out hover:text-white">{item.para}</p>
                                </div>
                            ))}
                        </div>
                    </div>
